...
## [0.12.0](https://github.com/ttw225/WrenAI/compare/wren-v0.11.0...wren-v0.12.0) (2026-07-03)
...
* **memory:** add 'wren memory watch' to auto-reindex on source changes ([#2418](https://github.com/ttw225/WrenAI/issues/2418)) ([d5911c5](https://github.com/ttw225/WrenAI/commit/d5911c5fb3352a8e7652d90db645b5d487084c37))
* **policy:** govern data-reading TVFs in all positions + structure source-func allowlist ([#2419](https://github.com/ttw225/WrenAI/issues/2419)) ([5ff51e4](https://github.com/ttw225/WrenAI/commit/5ff51e4a0f941761b3e12c9975b88c77e0e3d892))
...
* **wren:** add cross-dialect type translation to type_mapping ([#2410](https://github.com/ttw225/WrenAI/issues/2410)) ([e124ff5](https://github.com/ttw225/WrenAI/commit/e124ff538f512716a4d4779d495c6f4e38e3e072))
...
* **wren:** add v5 project layout (schema_version 5) ([#2386](https://github.com/ttw225/WrenAI/issues/2386)) ([d50b9bc](https://github.com/ttw225/WrenAI/commit/d50b9bcc58d4242e39b3d728c328b446e074997d))
...
* **wren:** case-aware column & model binding in the CTE rewriter ([#2400](https://github.com/ttw225/WrenAI/issues/2400)) ([58f3f51](https://github.com/ttw225/WrenAI/commit/58f3f5113ef2da7189541e4ad2b89182e6f86a48))
...
* **wren:** v5 project layout — knowledge/ first-class, memory decoupled from LanceDB ([#2399](https://github.com/ttw225/WrenAI/issues/2399)) ([3e34906](https://github.com/ttw225/WrenAI/commit/3e34906e4b690f454e0435e57fda8ec60a1b1595))


### Bug Fixes

* **athena:** treat DECIMAL(p) as scale 0, not a default non-zero scale ([#2403](https://github.com/ttw225/WrenAI/issues/2403)) ([22d3125](https://github.com/ttw225/WrenAI/commit/22d3125ced39c4e463ebff4d6c05bbeac1ea6209))
* **clickhouse:** default port-less clickhouse+https URLs to 8443, not 8123 ([#2412](https://github.com/ttw225/WrenAI/issues/2412)) ([06a51a8](https://github.com/ttw225/WrenAI/commit/06a51a81b002434365acacdf33d138599386df8f))
* **context:** preserve leading underscores in _snake_to_camel key conversion ([#2414](https://github.com/ttw225/WrenAI/issues/2414)) ([0cf9fa3](https://github.com/ttw225/WrenAI/commit/0cf9fa3ece85141ce5dcf51f0eba1908a6d547ce))
* disable transformers progress bar on Windows ([#2368](https://github.com/ttw225/WrenAI/issues/2368)) ([f91529b](https://github.com/ttw225/WrenAI/commit/f91529b62c6367440f0a6a87f894d3765663127f))
* **duckdb:** case-insensitive .duckdb discovery, deterministic attach aliases, and single-statement SQL hardening ([#2411](https://github.com/ttw225/WrenAI/issues/2411)) ([cfbd209](https://github.com/ttw225/WrenAI/commit/cfbd209d906497d0f2c0b481ffba08c9756d991c))
...
* finish wren-engine → wrenai rename cleanup ([#2425](https://github.com/ttw225/WrenAI/issues/2425)) ([0733d37](https://github.com/ttw225/WrenAI/commit/0733d379e15f041235bd7ff7449ecc421834a7f4))
* **genbi:** normalise null apps/schema_version in app index ([#2406](https://github.com/ttw225/WrenAI/issues/2406)) ([0c031d6](https://github.com/ttw225/WrenAI/commit/0c031d60b0fdbb28925970622434721f3fd631db))
...
* **osi:** skip empty expressions when picking a dialect expression ([#2413](https://github.com/ttw225/WrenAI/issues/2413)) ([bcf78d1](https://github.com/ttw225/WrenAI/commit/bcf78d19aa3dba61a79d633321f929f8a77ec740))
* **policy:** block table-valued functions reached via JOIN in strict mode ([#2405](https://github.com/ttw225/WrenAI/issues/2405)) ([a2a37b3](https://github.com/ttw225/WrenAI/commit/a2a37b39556f05e2aaa1a9550540cec1ed0a1aed))
* **postgres:** strip trailing semicolon before subquery-wrapping ([#2407](https://github.com/ttw225/WrenAI/issues/2407)) ([3122f4f](https://github.com/ttw225/WrenAI/commit/3122f4fbeda1175de21078296f7aaa4cf38b87cb))
* **trino:** treat DECIMAL(p) as scale 0, not a default non-zero scale ([#2404](https://github.com/ttw225/WrenAI/issues/2404)) ([1be4baa](https://github.com/ttw225/WrenAI/commit/1be4baaeba6f6a54febda73a5850bb47f25c6f40))
...
* **wren:** run full unit suite in CI and fix upgrade tests for schema_version 5 ([#2388](https://github.com/ttw225/WrenAI/issues/2388)) ([c36e56e](https://github.com/ttw225/WrenAI/commit/c36e56ebd285c0c07444ce7deb900055fe7cf538))
